...
export const MOCK_SLIDE_DATA = [
  ...
  },
  {
    ...
    data: {
      ...
      leftColumn: {
        ...
        content:
          "The iPhone helped transform urban spaces into connected hubs, creating new social dynamics and patterns of interaction.",
      },
      rightColumn: {
        title: "New Classes",
        content: [
  ...
  },
  {
    ...
    data: {
      ...
      imageUrl:
        "https://firebasestorage.googleapis.com/v0/b/kai-ai-f63c8.appspot.com/o/iphone-evolution.jpg?alt=media",
